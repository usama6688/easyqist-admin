...
import { useDeleteAdminMutation, useGetAdminsQuery } from '../../services/Api';
...
const Users = () => {
    ...
    const {
        data: getAdmins,
        refetch: getAdminsRefetch,
    } = useGetAdminsQuery({ params: { start: 0, limit: 100000 } });
